...
import kotlinx.android.synthetic.main.activity_pepperonipizacard.*
import kotlinx.android.synthetic.main.activity_pepperonipizacard.pepperoniaddtoart
import kotlinx.android.synthetic.main.activity_vegetable_burger.*

class pepperonipizacard : AppCompatActivity() {
    lateinit var incrementClass: IncrementClass
    lateinit var settextt: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pepperonipizacard)
